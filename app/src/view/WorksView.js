define(function(require, exports, module) {
    ...
    WorksView.prototype = Object.create(View.prototype);
    WorksView.prototype.constructor = WorksView;

    WorksView.DEFAULT_OPTIONS = {
    ...
    function _createBody() {
        this.body = new Surface({
            size: [true, true],
            content: 'Throughout my various experiences being as a web developer I have developed unique sets of skills. Welcome to my little world..',
            classes: [],
            properties: {
                color: 'white',
                textAlign: 'center',
